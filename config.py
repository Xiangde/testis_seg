...
parser.add_argument('--n_labels', type=int, default=2,help='number of classes') # your class number
parser.add_argument('--upper', type=int, default=1000, help='')
parser.add_argument('--lower', type=int, default=0, help='')
parser.add_argument('--norm_factor', type=float, default=500, help='')
...
parser.add_argument('--dataset_path',default = 'xx',help='fixed trainset root path')# your trainset path
parser.add_argument('--test_data_path',default = 'xx',help='Testset path')# your testset path
